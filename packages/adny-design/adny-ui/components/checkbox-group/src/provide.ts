...
import { CheckboxProvider } from "../../checkbox/src/provide";
...
export const CHECKBOX_GROUP_BIND_CHECKBOX_KEY = Symbol(
  "CHECKBOX_GROUP_BIND_CHECKBOX_KEY"
);
export const CHECKBOX_GROUP_COUNT_CHECKBOX_KEY = Symbol(
