<template>
  <component :is="sticky ? 'a-sticky' : Transition" :offset-top="sticky ? offsetTop : null">
    <div
...
<script lang="ts">
import ASticky from '../../sticky/src/sticky.vue'
...
import type { TabProvider } from '../../tab/src/provide'
