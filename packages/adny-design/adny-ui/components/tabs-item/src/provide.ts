...
import type { TabItemProvider } from "../../tab-item/src/provide";

export interface TabsItemsProvider {}

export const TABS_ITEMS_BIND_TAB_ITEM_KEY = Symbol(
  "TABS_ITEMS_BIND_TAB_ITEM_KEY"
);
export const TABS_ITEMS_COUNT_TAB_ITEM_KEY = Symbol(
  "TABS_ITEMS_COUNT_TAB_ITEM_KEY"
);
