  ...
  <div class="var-menu" ref="host" @click="handleClick">
    ...
    <teleport :to="teleport" :disabled="!teleport || disabled">
      <transition name="var-menu" @after-enter="onOpened" @after-leave="onClosed">
        <div
          class="var-menu__menu adny-elevation--3"
          ref="menu"
          :style="{
...
import { useZIndex } from '../../../compsables/context/zIndex'
  ...
  setup(props) {
    ...
    const computeTop = (alignment: string): number => {
      return alignment === 'top'
        ...
        : getTop(host.value as HTMLElement) + (host.value as HTMLElement).offsetHeight
    }
    const handleClick = () => {
      clickSelf = true
    }
