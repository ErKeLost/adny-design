<template>
  <div class="var-slider">
    ...
    <adny-form-detail :error-message="errorMessage" class="var-slider__form" var-slider-cover />
  </div>
</template>
...
import { useForm } from '../../../utils/provide'
...
@import "../../form-details/styles/formDetails";
